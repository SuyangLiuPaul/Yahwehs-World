...
export const STRUCTURES: Structure[] = [
  ...
  },
  {
    ...
    unstated: [
      ...
      '**底座形状同样有争议，而且和枝子形状是一套。** 凯旋门浮雕上是两层六角带饰板的底座；犹太传统记载的是三足底座，浮雕饰板上的生物图像也不该出现在圣殿器皿上——这正是「浮雕是否忠实于原物」争论的核心证据。所以上面的开关同时切换枝子和底座，把两种依据各自完整呈现，而不是拼在一起。',
      '杏花杯的轮廓曲线。经文说「形状像杏花，有球有花」，给了三段结构和五瓣的花形（杏花五瓣），没有给具体曲线。',
    ],
    variants: {
      key: 'branchForm',
      zh: '枝子形状',
      options: [
        { id: 'arch', zh: '弧形枝子 · 分层六角底座', note: '提图斯凯旋门浮雕，公元 1 世纪罗马，现存最早的图像。底座为两层六角带凹槽饰板。' },
        { id: 'straight', zh: '直线枝子 · 三足底座', note: '迈蒙尼德亲笔手稿（12 世纪）与拉比传统；哈巴德沿用至今。' },
      ],
    },
  ...
  },
  {
    ...
    unstated: [
      ...
      '**门的宽度经文用比例给出，高度没有。** 王上 6:33 说外殿门框「有墙的四分之一」——二十肘的墙就是五肘；6:31 内殿门「有墙的五分之一」——四肘。高度未记，模型取十二肘与十肘。',
