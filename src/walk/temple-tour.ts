...
export const TEMPLE_TOUR: Stop[] = [
  ...
  { x: 55, z: 22, at: { x: 32, z: 0 }, pitch: 0.08, travel: 0, dwell: 3,
    zh: '院内东望 · 廊与铜柱在殿前',
  ...
  { x: 48, z: 20, at: { x: 44, z: 5.5 }, atY: 9, travel: 3, dwell: 4,
  ...
  { x: -11.5, z: 0, at: { x: -20, z: 0 }, atY: 5, travel: 0.8, dwell: 5, cut: true,
