...
export const UNITS: Unit[] = [
  ...
  { id: 'matthew', zh: '马太福音', en: 'Matthew', from: k(40, 1, 1),
    plan: [
      wip('scene', '山上的宝训 · 你坐在他坐的地方，看见那群人（太 5:1）',
          'The sermon on the mount — you sit where he sat, and see the multitude (Matt 5:1)'),
      wip('route', '降生与逃往埃及', 'The nativity, and the flight into Egypt')] },
  { id: 'mark', zh: '马可福音', en: 'Mark', from: k(41, 1, 1),
    plan: [wip('scene', '加利利海上的风浪 · 你在船上，浪打进来（可 4:37–39）',
          'The storm on the sea — you are in the boat, and the waves beat into it (Mark 4:37–39)')] },
  { id: 'luke', zh: '路加福音', en: 'Luke', from: k(42, 1, 1),
    plan: [wip('scene', '客店与马槽 · 经文只记了布、槽和没有地方（路 2:7）；牛和驴不在记载里',
          'The inn and the manger — the text gives swaddling clothes, a manger and no room (Luke 2:7); the ox and the ass are not in it')] },
  ...
  { id: 'rev-churches', zh: '给七个教会的信', en: 'The seven churches', from: k(66, 1, 1),
    plan: [
      wip('scene', '七个金灯台 · 面貌如烈日放光，所以看见的是光不是脸（启 1:12–16）',
          'Seven golden lampstands — his countenance as the sun shineth in his strength, so what is seen is the light (Rev 1:12–16)'),
